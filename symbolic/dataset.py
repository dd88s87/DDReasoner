...
def initialize_datasets(args):
    ...
    if args.task=="sudoku":
        ...
        data_path = 'data/warcraft/warcraft_shortest_path_oneskin/12x12/'
        ...
        datasets['train'] = PreProcessedWarcraft(train_inputs, train_weights, train_labels, num_pts=train_inputs.shape[0])
        datasets['valid'] = PreProcessedWarcraft(valid_inputs, valid_weights, valid_labels, num_pts=valid_inputs.shape[0])
        datasets['test'] = PreProcessedWarcraft(test_inputs, test_weights, test_labels, num_pts=test_inputs.shape[0])
